        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container-fluid">
                <div class="navbar-brand">
                    <a aria-label="Homepage" class="d-sm-b prl2-sm prl3-lg" href="index.html">
                ...
                <div class="d-flex justify-content-end me-5">
                    ...
                    <div class="shopping-cart nav-item dropdown dropstart me-2">
                        <a href="#" class="nav-link d-flex justify-content-center" aria-label="Shopping cart and item counter" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <footer class="bg-dark text-center text-white">
        ...
        <div class="container p-4 pb-0">
            ...
            <section class="mb-4">
                ...
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.facebook.com/nike/" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                ...
                <a class="btn btn-outline-light btn-floating m-1" href="https://twitter.com/nike" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                ...
                <a class="btn btn-outline-light btn-floating m-1" href="https://www.instagram.com/nike/" role="button"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
